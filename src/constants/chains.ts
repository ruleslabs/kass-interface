...
// ].filter((id) => typeof id === 'number' || typeof id === 'string') as SupportedChainId[]
...
//   [EthereumChainId.MAINNET]: [StarknetChainId.MAINNET],
//   [EthereumChainId.GOERLI]: [StarknetChainId.TESTNET, StarknetChainId.TESTNET2],
// }
